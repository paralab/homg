...
for f = 1:Nfaces %
  ...
  rhsu(idxv)  = rhsu(idxv) + ...
      taur * Jf .* (refel.Mr * lam(idxf));  %changed from previous implementation + instead of -
...
qxrhs = -eMatInv * rhsqx;  %changed from previous implementation - instead of +

qyMatrix = eMatInv * Key;  %changed from previous implementation + instead of -
qyrhs = -eMatInv * rhsqy;  %changed from previous implementation - instead of +
