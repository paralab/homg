...
\begin{figure}
	...
	\caption{\label{fig:smoothers2} Error decay for different
          ...
          within a single multigrid v-cycle (b,d,f) for a
          two-dimensional, constant coefficient Laplace problem on a
          unit square. Plotted are the coefficients of the error
...
\subsubsection{Schwarz-based methods}\label{subsec:schwarz}
