...
computational cost of the different approaches to high-oder multigrid
discussed in Section~\ref{sec:approaches}. We denote by $s$ the number
of smoothing steps on the finest multigrid level. Note that smoothers
such as Jacobi, Gauss-Seidel or Chebyshev requsmoothers amount to
matrix-vector products.


\begin{itemize}
\item High-order $h$-multigrid: 
\item p-multigrid
\end{itemize}
