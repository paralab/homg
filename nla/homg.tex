...
discretized problems are possible. One option is the construction of a
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\caption{$p=16$, single v-cycle}
	\end{subfigure}
	\caption{\label{fig:smoothers-var} The smoothing properties of the smoothers for  two-dimensional warped geometry with varying coefficient $\mu(x,y) = 1 + 10^6(\cos^2(2\pi x) + \cos^2(2\pi y))$.
	}
\end{figure}
