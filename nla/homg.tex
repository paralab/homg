...
\begin{figure}
	...
	\caption{\label{fig:mesh} Two and three dimensional warped
          ...
          illustrates the value of the coefficient $\mu(\bs x)$, which
        varies on the element level but is plotted as constant on each
        element for illustration purposes. \todo{Would that be hard to change?}}
\end{figure}
