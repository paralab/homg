...
\begin{figure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi1]{data/smoother-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev1]{data/smoother-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor1]{data/smoother-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\begin{tikzpicture}[scale=0.8]
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi1]{data/vcycle-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev1]{data/vcycle-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor1]{data/vcycle-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi2]{data/smoother-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev2]{data/smoother-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor2]{data/smoother-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi2]{data/vcycle-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev2]{data/vcycle-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor2]{data/vcycle-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi4]{data/smoother-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev4]{data/smoother-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor4]{data/smoother-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi4]{data/vcycle-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev4]{data/vcycle-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor4]{data/vcycle-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi8]{data/smoother-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev8]{data/smoother-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor8]{data/smoother-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=8$, smoothing}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\begin{tikzpicture}[scale=0.8]
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-8,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-const-box.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi8]{data/vcycle-const-box.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev8]{data/vcycle-const-box.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor8]{data/vcycle-const-box.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=8$, single v-cycle}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\begin{tikzpicture}[scale=0.8]
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi1]{data/smoother-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev1]{data/smoother-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor1]{data/smoother-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=1$, smoothing}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\begin{tikzpicture}[scale=0.8]
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi1]{data/vcycle-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev1]{data/vcycle-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor1]{data/vcycle-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=1$, single v-cycle}
	\end{subfigure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi2]{data/smoother-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev2]{data/smoother-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor2]{data/smoother-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=2$, smoothing}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi2]{data/vcycle-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev2]{data/vcycle-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor2]{data/vcycle-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=2$, single v-cycle}
	\end{subfigure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi4]{data/smoother-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev4]{data/smoother-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor4]{data/smoother-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=4$, smoothing}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi4]{data/vcycle-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev4]{data/vcycle-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor4]{data/vcycle-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=4$, single v-cycle}
	\end{subfigure}
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081]
		\addplot[color=black]  table[x=dof, y=u]{data/smoother-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi8]{data/smoother-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev8]{data/smoother-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor8]{data/smoother-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=8$, smoothing}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\begin{semilogyaxis}[ymajorgrids,ymin=1e-5,ymax=2,xmin=0,xmax=1081,yticklabels={,,}]
		\addplot[color=black]  table[x=dof, y=u]{data/vcycle-var-shell.dat};
		\addplot[color=blue!70,opacity=0.5]   table[x=dof, y=jacobi8]{data/vcycle-var-shell.dat};
		\addplot[color=red!50!black,opacity=0.5] table[x=dof, y=chebyshev8]{data/vcycle-var-shell.dat};
		\addplot[color=green!70!black,opacity=0.5]  table[x=dof, y=ssor8]{data/vcycle-var-shell.dat};
		\end{semilogyaxis}
		\end{tikzpicture}
		\caption{$p=8$, single v-cycle}
	\end{subfigure}
...
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order1-const-box.tikz}
% 		\caption{$p=1$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order1-const-box.tikz}
% 		\caption{$p=1$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order2-const-box.tikz}
% 		\caption{$p=2$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order2-const-box.tikz}
% 		\caption{$p=2$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order4-const-box.tikz}
% 		\caption{$p=4$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order4-const-box.tikz}
% 		\caption{$p=4$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order8-const-box.tikz}
% 		\caption{$p=8$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order8-const-box.tikz}
% 		\caption{$p=8$, single v-cycle}
% 	\end{subfigure}
% 	\caption{\label{fig:smoothers2} The smoothing properties of the smoothers for constant coefficient 2D box.}
% \end{figure}
...
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order1-var-box.tikz}
% 		\caption{$p=1$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order1-var-box.tikz}
% 		\caption{$p=1$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order2-var-box.tikz}
% 		\caption{$p=2$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order2-var-box.tikz}
% 		\caption{$p=2$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order4-var-box.tikz}
% 		\caption{$p=4$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order4-var-box.tikz}
% 		\caption{$p=4$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order8-var-box.tikz}
% 		\caption{$p=8$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order8-var-box.tikz}
% 		\caption{$p=8$, single v-cycle}
% 	\end{subfigure}
% 	\caption{\label{fig:smoothers3} The smoothing properties of the smoothers for variable coefficient 2D box.}
% \end{figure}
...
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order1-const-shell.tikz}
% 		\caption{$p=1$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order1-const-shell.tikz}
% 		\caption{$p=1$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order2-const-shell.tikz}
% 		\caption{$p=2$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order2-const-shell.tikz}
% 		\caption{$p=2$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order4-const-shell.tikz}
% 		\caption{$p=4$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order4-const-shell.tikz}
% 		\caption{$p=4$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order8-const-shell.tikz}
% 		\caption{$p=8$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order8-const-shell.tikz}
% 		\caption{$p=8$, single v-cycle}
% 	\end{subfigure}
% 	\caption{\label{fig:smoothers4} The smoothing properties of the smoothers for constant coefficient 2D fan.}
% \end{figure}
...
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order1-var-shell.tikz}
% 		\caption{$p=1$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order1-var-shell.tikz}
% 		\caption{$p=1$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order2-var-shell.tikz}
% 		\caption{$p=2$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order2-var-shell.tikz}
% 		\caption{$p=2$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order4-var-shell.tikz}
% 		\caption{$p=4$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order4-var-shell.tikz}
% 		\caption{$p=4$, single v-cycle}
% 	\end{subfigure}
% 	\\
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/smoothers-order8-var-shell.tikz}
% 		\caption{$p=8$, smoothing}
% 	\end{subfigure}
% 	\begin{subfigure}[b]{0.49\textwidth}
% 		\centering
% 		\input{tikz/vcycle-order8-var-shell.tikz}
% 		\caption{$p=8$, single v-cycle}
% 	\end{subfigure}
% 	\caption{\label{fig:smoothers5} The smoothing properties of the smoothers for variable coefficient 2D fan.}
% \end{figure}
