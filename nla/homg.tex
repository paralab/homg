...
\gsnote{nodal spectral elements}
...
require assembled finite element matrices, which becomes critical for
high-order methods. Moreover, we discuss parallel aspects relevant for
implementations on shared or distributed memory architectures.
